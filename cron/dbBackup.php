...
$message ="<font face='Courier New' size=2><B>Go 0n Group - MySQL Backup ... </b><br>";
...
$from  = "MySQL Backup <admin@goon.net.vn>";    // Who to send the emails to, enter ur correct id. 
...
if($send_email == "yes" ){ 
 ...
 if ($ok) { 
	echo "<b>Database backup created and sent ! File name $filename2</b>";
 }
 else { 
