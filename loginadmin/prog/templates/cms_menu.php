<?
function	template_edit($url,$func,$txt_cat,$cat,$txt_ten,$txt_hien_thi,$txt_type,$txt_noi_bat,$txt_rss_link,$error,$lang)
{
	$lang=$_SESSION['lang'];
?>
...
<input type="hidden" name="lang" value="<?=$lang?>" />
	<table cellpadding="0" cellspacing="0" width="100%" class="form_chung">
        ...
        <tr class="radio">
            ...
            <td>Link RSS</td>
            <td>
                <input type="text" name="txt_rss_link" value="<?=$txt_rss_link?>" class="inputbox" style="width:90%" />
            </td>
        </tr>
        <tr>
            <td colspan="2"></td>
...
{
	global $db;
	$r	=	$db->select("goon_cms_menu","cat = '".$txt_cat."'");
